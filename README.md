# Python Assignment1
This dataset on evictions in NYC was retrieved from NYC Open Data. I wanted to identify which borough was experiencing the highest eviction rates. I copied the raw data into Google Sheets and removed unnecessary columns to clean the dataset. The final version included only the year of the violation, the borough, and the postal code.
